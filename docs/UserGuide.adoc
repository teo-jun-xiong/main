...
- Format: `recipe INDEX edit ingredient i/INGREDIENT q/QUANTITY`
- Examples:
* `recipe 1 edit ingredient i/Egg q/2` +
Changes the quantity of eggs to 3 in the 1st recipe's list of ingredients.
* `recipe 2 edit ingredient i/Milk q/100 ml` +
...
- Examples:
* `recipe 1 remove ingredient i/Egg q/1` +
